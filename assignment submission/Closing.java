...
/**
 * Using erosion and dilation method, implement a grayscale closing with a square structuring element of a size 5x5 pixels.
 * 
 * @author Li Tang
 * @version 2018.01.18
 */
public class Closing {
	public static void main(String [] args)
	{
		...
		//using dilation method and erosion method.
		Dilation.dilation(img.height(),img.width(), img, img2);
		Erosion.erosion(img.height(),img.width(),img2,img3);
